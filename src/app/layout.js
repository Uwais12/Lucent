...
export const metadata = {
  ...
  title: {
    default: "Lucent — Learn anything, taught by anyone. Free.",
    template: "%s | Lucent",
  },
  description:
    "An interactive course platform like Duolingo — anyone can publish a course, anyone can take one. Bite-sized lessons with auto-graded exercises and quizzes. Free for everyone.",
  keywords: [
  ...
  openGraph: {
    title: "Lucent — Learn anything, taught by anyone. Free.",
    description:
      "An interactive course platform like Duolingo. Anyone can publish a course; anyone can take one. Auto-graded exercises, quizzes, XP — all free.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Lucent — Learn anything, taught by anyone. Free.",
    description:
      "An interactive course platform like Duolingo. Anyone can publish a course; anyone can take one. Free, forever.",
  },
  robots: {
    index: true,
    follow: true,
